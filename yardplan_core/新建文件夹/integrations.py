...
class TOSLoader:
    ...
    def build_type2_space_allocation_plan(
        ...
        *,
        containers: List[Container],
        yard: Any,
        allowed_block_ids_by_business: Optional[
            Dict[BusinessType, Set[str]]
        ] = None,
    ) -> Dict[str, Any]:
        ...
        for group_key, members in containers_by_group.items():
            ...
            if allowed_block_ids_by_business and members:
                allowed_block_ids = allowed_block_ids_by_business.get(
                    members[0].business_type
                )
